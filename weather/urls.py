...
urlpatterns = [
    ...
    path(
        "city_weater_class_based/<str:cityname>",
        CityWeatherDetailView.as_view(),
        name="city_weather_class_based",
    ),
    ...
    path(
        "delete_city/<str:cityname>", DeleteCityView.as_view(), name="delete_city_view"
    ),
]
